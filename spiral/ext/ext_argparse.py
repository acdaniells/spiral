"""
Spiral argparse extension module.
"""
...
class ArgparseController(ControllerHandler):
    ...
    def _setup_controllers(self):  # noqa: C901
    ...
    def _process_arguments(self, controller):
        ...
        LOG.debug(f"processing arguments for '{label}' controller namespace")
    ...
    def _process_commands(self, controller):
        label = controller._meta.label
        LOG.debug(f"processing commands for '{label}' controller namespace")
        ...
        for command in commands:
            ...
            LOG.debug(
                f"adding command '{command['label']}' "
            ...
            LOG.debug(
                f"processing arguments for '{command['label']}' command namespace"
            )
